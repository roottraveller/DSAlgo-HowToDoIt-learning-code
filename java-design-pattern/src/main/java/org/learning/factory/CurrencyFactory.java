...
/*
 * The Factory Method Pattern encapsulates the object creation process and allows it to be controlled by subclasses
 * or specific implementations. This promotes loose coupling between the client code and the created objects, as the
 * client code interacts with the factory method interface rather than directly with the concrete classes being instantiated.
 * Example:
 ...
 * https://javarevisited.blogspot.com/2013/01/difference-between-factory-and-abstract-factory-design-pattern-java
 * .html#axzz7YGkYs1WH
 */
