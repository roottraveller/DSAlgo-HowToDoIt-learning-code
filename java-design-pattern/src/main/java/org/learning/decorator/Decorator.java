 ...
 * allowing new features to be added without altering their original classes. It is used when subclassing becomes
 * impractical or when different combinations of functionalities are needed for independent objects. Additionally,
 * it's employed to add functionality to individual objects at runtime, rather than applying changes to all objects.
 * Example:
